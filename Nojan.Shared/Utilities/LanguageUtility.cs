...
public static class LanguageUtility
{
    ...
    public static string PersianDigitsToEnglish(this string persianStr)
    {
        if (string.IsNullOrEmpty(persianStr)) return string.Empty;
        ...
        return LettersDictionary.Aggregate(persianStr, (current, item) => current.Replace(item.Key, item.Value));
    }

    public static string ReplaceAllArabicToPersian(this string str)
    {
        return str.Replace('ي', 'ى').Replace('ك', 'ک');
    }
}