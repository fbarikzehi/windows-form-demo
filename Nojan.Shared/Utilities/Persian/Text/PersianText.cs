namespace Nojan.Shared.Utilities.Persian.Numbers
{
    class PersianText
    {
       ...
       public static string PersianNumberToString(string inputNumber)
        {
            ...
            var numberLength3 = 0;
            var lengthToSelectFirstPart = 0;
            for (var i = 0; i < partCount; i++)
            {
                if (i == 0)
                {
                    lengthToSelectFirstPart = System.Convert.ToInt32(tempNumber.Length - ((partCount - 1) * 3));
                    numberLength3 = System.Convert.ToInt32(tempNumber.Substring((i * 3), lengthToSelectFirstPart));
                }
                else
                {
                    numberLength3 = System.Convert.ToInt32(tempNumber.Substring(lengthToSelectFirstPart + ((i - 1) * 3), 3));
                }
